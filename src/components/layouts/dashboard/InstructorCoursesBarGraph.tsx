...
interface InstructorCoursesBarGraphProps {
	barChartData: any;
	totalCourses: number;
}

const InstructorCoursesBarGraph = ({ barChartData, totalCourses }: InstructorCoursesBarGraphProps) => {
	...
	return (
		<Box
			...
			<Typography variant={isMobileSize ? 'h6' : 'h5'}>My Courses</Typography>
...
export default InstructorCoursesBarGraph;
