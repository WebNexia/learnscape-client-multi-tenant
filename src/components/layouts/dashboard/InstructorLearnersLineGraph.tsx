...
interface InstructorLearnersLineGraphProps {
	chartData: any;
	totalUsers: number;
}

const InstructorLearnersLineGraph = ({ chartData, totalUsers }: InstructorLearnersLineGraphProps) => {
	...
	return (
		<Box
			...
			<Typography variant={isMobileSize ? 'h6' : 'h5'}>My Learners</Typography>
...
export default InstructorLearnersLineGraph;
